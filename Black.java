public class Black extends Gen5 {
    String description;
    static String gameVersion = "Black";

    public Black() {}

    public Black(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Black pokemon = new Black();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Black(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Black pokemon = new Black();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
