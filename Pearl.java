public class Pearl extends Gen4{
    String description;
    static String gameVersion = "Pearl";

    public Pearl() {}

    public Pearl(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Pearl pokemon = new Pearl();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Pearl(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Pearl pokemon = new Pearl();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
