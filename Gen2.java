public class Gen2 extends Pokemon{
    ...
    public Gen2(String name, int hp, int attack, int defense, int speed, int type1, String picturePath) {
        Gen2 pokemon = new Gen2();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Gen2(String name, int hp, int attack, int defense, int speed, int type1, int type2, String picturePath) {
        Gen2 pokemon = new Gen2();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
