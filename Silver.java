public class Silver extends Gen2{
    String description;
    static String gameVersion = "Silver";

    public Silver() {}

    public Silver(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Silver pokemon = new Silver();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Silver(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Silver pokemon = new Silver();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
