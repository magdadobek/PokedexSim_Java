public class White2 extends Gen5{
    String description;
    static String gameVersion = "White2";

    public White2() {}

    public White2(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        White2 pokemon = new White2();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public White2(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        White2 pokemon = new White2();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
