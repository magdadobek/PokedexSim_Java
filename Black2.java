public class Black2 extends Gen5{
    String description;
    static String gameVersion ="Black2";

    public Black2() {}

    public Black2(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Black2 pokemon = new Black2();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Black2(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Black2 pokemon = new Black2();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
