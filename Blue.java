public class Blue extends Gen1{
    String description;
    static String gameVersion = "Blue";

    public Blue() {}

    public Blue(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Blue pokemon = new Blue();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Blue(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Blue pokemon = new Blue();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
