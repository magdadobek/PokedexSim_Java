public class Gold extends Gen2{
    String description;
    static String gameVersion="Gold";

    public Gold() {}

    public Gold(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Gold pokemon = new Gold();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Gold(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Gold pokemon = new Gold();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
