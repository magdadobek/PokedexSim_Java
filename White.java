public class White extends Gen5{
    String description;
    static String gameVersion = "White";

    public White() {}

    public White(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        White pokemon = new White();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public White(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        White pokemon = new White();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
