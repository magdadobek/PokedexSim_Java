public class Emerald extends Gen3{
    String description;
    static String gameVersion = "Emerald";

    public Emerald() {}

    public Emerald(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Emerald pokemon = new Emerald();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Emerald(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Emerald pokemon = new Emerald();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
