public class Crystal extends Gen2{
    String description;
    static String gameVersion="Crystal";

    public Crystal() {}

    public Crystal(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Crystal pokemon = new Crystal();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Crystal(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Crystal pokemon = new Crystal();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
