public class Sapphire extends Gen3{
    String description;
    static String gameVersion = "Sapphire";

    public Sapphire() {}

    public Sapphire(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Sapphire pokemon = new Sapphire();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Sapphire(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Sapphire pokemon = new Sapphire();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
