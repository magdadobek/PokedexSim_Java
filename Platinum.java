public class Platinum extends Gen4{
    String description;
    static String gameVersion = "Platinum";

    public Platinum() {}

    public Platinum(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Platinum pokemon = new Platinum();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Platinum(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Platinum pokemon = new Platinum();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
