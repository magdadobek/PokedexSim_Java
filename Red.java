public class Red extends Gen1{
    String description;
    static String gameVersion = "Red";

    public Red() {}

    public Red(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Red pokemon = new Red();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Red(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Red pokemon = new Red();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
