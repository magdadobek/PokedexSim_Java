public class Diamond extends Gen4{
    String description;
    static String gameVersion = "Diamond";

    public Diamond() {}

    public Diamond(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Diamond pokemon = new Diamond();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Diamond(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Diamond pokemon = new Diamond();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
