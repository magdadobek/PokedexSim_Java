public class Yellow extends Gen1{
    String description;
    static String gameVersion = "Yellow";

    public Yellow() {}

    public Yellow(String name, int hp, int attack, int defense, int speed, int type1, String description, String picturePath) {
        Yellow pokemon = new Yellow();
        pokemon.name =name;
        pokemon.hp =hp;
    ...
    public Yellow(String name, int hp, int attack, int defense, int speed, int type1, int type2, String description, String picturePath) {
        Yellow pokemon = new Yellow();
        pokemon.name =name;
        pokemon.hp =hp;
        pokemon.attack =attack;
